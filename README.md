...
## Competition
* [CHallenge on Innovation and Problem solving through Technology Advancement (CHIPTA) Hackathon](https://web.archive.org/web/20241112191232/https://chipta.mampu.gov.my/) by [MAMPU](https://mampu.gov.my/).

## Data

### Civic & Civil Society
* [Various Voters, Census(DUN & Parliament), Results, Candidates Data](https://github.com/Thevesh/analysis-election-msia/tree/main/data) - Compiled CSV datasets on voters, census breaks by constituency (DUN & Parliament), election results, and candidate profiles by [Thevesh](https://github.com/Thevesh/).
* [Malaysian Election Corpus (MECo) - Federal & State Election Results since 1955](https://github.com/Thevesh/paper-meco-results) - Open-access panel database of all ~10,000 electoral contests since 1955 with candidate demographics, coalitions, and constituency-level results in CSV and Parquet formats by [Thevesh](https://github.com/Thevesh/).
...
* [Politikus](https://politikus.sinarproject.org/open-data) - Structured open data on political integrity, PEPs, government procurement, and elections following Popolo and BODS standards by [Sinar Project](https://github.com/Sinar/).
...
### Geospatial Data
* [MECo: Electoral Maps and Cartograms since 1954](https://github.com/Thevesh/paper-meco-maps) - Digital electoral boundaries for all 19 delimitation exercises since 1954, election maps, and cartograms (GeoJSON, TopoJSON, GeoParquet, FlatGeobuf, KML) by [Thevesh](https://github.com/Thevesh/).
...
* [Malaysian Election Dataviz](https://malaysianelectiondataviz.com/) - Interactive embeddable election result maps and charts for GE15 and state elections by [Thibi.co](https://github.com/Thibico/).
* [Malaysian Civil Society Open Data](https://data.sinarproject.org/) - CKAN portal with datasets on political integrity, government procurement, and governance by [Sinar Project](https://github.com/Sinar/).
